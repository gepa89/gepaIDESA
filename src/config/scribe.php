...
return [
	...
	'auth' => [
    /*
     * The type of authentication used by the API.
     * For example, "Bearer Token", "API Key", "Basic Auth", etc.
     */
    'enabled' => true, // Enable authentication in Scribe
    'in' => 'header', // The token will be sent in the request headers
    'name' => 'Authorization', // The header name for sending the token
    ...
    'extra_info' => '', // Additional description
],
